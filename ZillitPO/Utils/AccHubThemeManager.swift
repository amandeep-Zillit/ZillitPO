//
//  AccHubThemeManager.swift
//  ZillitPO
//
//  Theme manager for the AccountHub module. Mirrors the live file —
//  drives every `Color.gold / .bgBase / .bgSurface / ...` token used
//  across the AccountHub screens.
//

import SwiftUI

// MARK: - ThemeManager (singleton, drives all Color.xxx tokens)
