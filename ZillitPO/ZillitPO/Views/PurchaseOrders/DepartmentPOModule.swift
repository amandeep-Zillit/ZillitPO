...
struct DepartmentPOModule: View {
    ...
    var body: some View {
        ZStack(alignment: .bottomTrailing) {
            ...
            // Hidden NavigationLink to push Drafts/Templates page
            NavigationLink(
...
struct DraftsTemplatesPage: View {
    ...
    var body: some View {
        ZStack(alignment: .bottomTrailing) {
            ...
            // Hidden NavigationLink to push edit template page
            NavigationLink(
            ...
            // Hidden NavigationLink to create new template page
            NavigationLink(
            ...
            List {
                ...
                Section {
                    HStack(spacing: 10) {
                        ...
                        // Save Template button — requires template name
                        Button(action: {
                            if templateName.trimmingCharacters(in: .whitespaces).isEmpty {
                                ctValidationMessage = "Please enter a template name"
                                showCtValidationAlert = true
                            } else {
                                createTemplate()
                            }
                        }) {
                        ...
                        .alert(isPresented: $showCtValidationAlert) {
                            Alert(title: Text("Missing Required Fields"), message: Text(ctValidationMessage), dismissButton: .default(Text("OK")))
                        }
                    }
                }
            }
