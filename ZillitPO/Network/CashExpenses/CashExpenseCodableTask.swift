...
enum CashExpenseCodableTask {
    case fetchMetadata((Result<ZLGenericResponse<CashExpenseMetadata>?, Error>) -> Void)
    case fetchMyFloats((Result<ZLGenericResponse<[FloatRequest]>?, Error>) -> Void)
    case fetchAllFloats((Result<ZLGenericResponse<[FloatRequest]>?, Error>) -> Void)
    case fetchActiveFloats((Result<ZLGenericResponse<[FloatRequest]>?, Error>) -> Void)
    case fetchApprovalQueue((Result<ZLGenericResponse<[FloatRequest]>?, Error>) -> Void)
    case fetchMyClaims((Result<ZLGenericResponse<[ClaimBatch]>?, Error>) -> Void)
    case fetchMyBatches(String?, (Result<ZLGenericResponse<[ClaimBatch]>?, Error>) -> Void)
    case fetchAllClaims((Result<ZLGenericResponse<[ClaimBatch]>?, Error>) -> Void)
    case fetchCodingQueue((Result<ZLGenericResponse<[ClaimBatch]>?, Error>) -> Void)
    case fetchAuditQueue((Result<ZLGenericResponse<[ClaimBatch]>?, Error>) -> Void)
    case fetchApprovalQueueClaims((Result<ZLGenericResponse<[ClaimBatch]>?, Error>) -> Void)
    case fetchPaymentRouting((Result<ZLGenericResponse<PaymentRoutingResponse>?, Error>) -> Void)
    case createFloatRequest([String: Any], (Result<Data?, Error>) -> Void)
    case fetchFloatDetails(String, (Result<ZLGenericResponse<FloatDetailsResponse>?, Error>) -> Void)
    case getFloat(String, (Result<ZLGenericResponse<FloatRequest>?, Error>) -> Void)
    ...
    case fetchFloatHistory(String, (Result<ZLGenericResponse<[FloatHistoryEntry]>?, Error>) -> Void)
    case fetchClaimHistory(String, (Result<ZLGenericResponse<[FloatHistoryEntry]>?, Error>) -> Void)
...
extension CashExpenseCodableTask: FCCodableDataTask {
    var urlDataTask: URLSessionDataTask? {
        ...
        case .fetchMetadata(let c):
            ...
            return FCURLSession.sharedInstance.session?.codableResultTask(with: r, completion: c)
